...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bRegisterR.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String fname = etFName.getText().toString();
                final String lname = etLName.getText().toString();

                final String uname = etUNameR.getText().toString();
                ...
                RegisterRequest registerRequest = new RegisterRequest(fname,lname,uname,password,email,pnumber,responseListner);
